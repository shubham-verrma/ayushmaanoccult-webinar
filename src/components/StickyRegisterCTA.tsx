        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <a 
              ...
              className="bg-gradient-to-r from-gold to-copper text-orange-900 px-6 py-3 rounded-full text-lg font-bold hover:shadow-lg hover:scale-105 transition-all duration-300 border border-gold/30"
            >
              Register Now
            </a>
            <button
