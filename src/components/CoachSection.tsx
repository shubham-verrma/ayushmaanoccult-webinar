        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-16">
            <a 
              ...
              className="bg-gradient-to-r from-gold to-copper text-orange-900 px-8 sm:px-12 py-4 sm:py-5 rounded-full text-lg sm:text-xl font-bold hover:shadow-2xl hover:shadow-gold/40 hover:scale-105 transition-all duration-300 border-2 border-gold/50"
            >
              Register Now
            </a>
          </div>
